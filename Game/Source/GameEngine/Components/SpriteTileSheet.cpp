...
namespace Comp
{
	void SpriteTileSheet::SetScreenTargetLocationAndTileDimensions(const sfloat screenPositionX, const sfloat screenPositionY, const glm::ivec2 spriteSheetTileDimensions)
	{
		...
		this->vertexData.at(0).SetPosition(glm::vec3{ screenPositionX + halfWidth, screenPositionY + this->height, 0.0f });//Top right corner
		...
		this->vertexData.at(4).SetPosition(glm::vec3{ screenPositionX + halfWidth, screenPositionY, 0.0f });//Bottom right corner
		this->vertexData.at(5).SetPosition(glm::vec3{ screenPositionX + halfWidth, screenPositionY + this->height, 0.0f });//Top right corner
